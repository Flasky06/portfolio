    ...
    <main className="mt-20">
      <section className="flex flex-col max-w-4xl mx-auto items-center justify-center gap-8">
        ...
        <div className="flex gap-4">
          <span className="h-16 w-16 border flex items-center justify-center rounded-full cursor-pointer ">
      ...
      <section className=" flex flex-col max-w-4xl mx-auto  justify-center gap-4 h-screen">
        ...
        <h3 className="text-lg font-extralight">Who am i ?</h3>
        <p className="text-md">
        ...
        <p
          className="cursor-pointer py-1 px-2 text-blue-400 hover:text-blue-600 underline underline-offset-4
"
        >
      ...
      <section className="flex flex-col max-w-3xl mx-auto items-center justify-center gap-4 mt-6">
        <h3 className="text-center text-xl tracking-widest uppercase text-[#5651e5]">
          Projects
        </h3>
      </section>
      ...
      <section className="flex flex-col max-w-7xl mx-auto  justify-center gap-8 mt-6">
        ...
        <div className="flex lg:flex-row flex-col gap-4">
          <div className=" w-1/3 flex flex-col items-center h-full border rounded-xl p-4">
            <div className="lg:p-4 h-full ">
              ...
              <div className="">
                <h2 className="py-1 text-slate-950">Bonface Njuguna </h2>
              ...
              <div>
                ...
                <div className="flex items-center justify-start py-4 space-x-3">
                  <Link
                    ...
                    rel="noreferrer"
                  >
                    <div className="rounded-full border p-3 cursor-pointer hover:scale-110 ease-in duration-300">
                      <FaGithub />
                    </div>
                  </Link>
                  <Link
